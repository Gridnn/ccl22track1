...
class DataGenerator(object):
    ...
    def __init__(self, save_path):
        self.probs_all = 0.05
        self.disorder_prob = 0.0
        self.missing_prob = 0.0
        self.selection_prob = 1.0
        self.redundant_prob = 0.0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='../../data/articles.json',
